...
export default function Protected() {
    ...
    return (
        <>
            {
                user?.id ?
                    <main className="h-screen w-screen p-2 flex">
                        <aside className="w-[20%] h-full border-r-[0.5px] border-gray-200 flex flex-col items-center space-y-10">
                            ...
                            <nav>
                                <ul className="space-y-10 flex flex-col items-center">
                                    ...
                                    <li className="flex gap-x-3 items-center">
                                        ...
                                        <Link className="font-medium" to='/tasks'>Tasks</Link>
                                    </li>
                                    <li className="flex gap-x-3 items-center">
                                        ...
                                        <Link className="font-medium" to='/teams'>TeamWork</Link>
                                    </li>
                                </ul>
                            </nav>
                        </aside>
