...
export default function Navigation({ taskMenuState, teamMenuState, children }: {
    taskMenuState: { subTaskMenu: boolean, setSubTaskMenu: React.Dispatch<React.SetStateAction<boolean>> },
    teamMenuState: { subTeamMenu: boolean, setSubTeamMenu: React.Dispatch<React.SetStateAction<boolean>> },
    children?: ReactNode
}) {

    const { subTaskMenu, setSubTaskMenu } = taskMenuState;
    const { subTeamMenu, setSubTeamMenu } = teamMenuState;
